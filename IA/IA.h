...
// IA.c
    ...
    t_action IA_creerActionSelonPriorite(t_joueur *joueur, t_priorite* priorites, int nbCaseX, int prioMax); // retourne l'action la plus logique selon les priorités données
