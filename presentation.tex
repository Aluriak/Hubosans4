...
\begin{document}
    ...
    \framesubtitle{Détection de puissance 4}
    	\begin{block}{Recherche des valeurs MAX}
		    Calcule les valeurs maximales dans toutes les directions pour un point donné. Diminue le nombre de calculs et évite les erreurs de segmentations.\\
	\end{block}
	\begin{block}{Test du puissance 4}
